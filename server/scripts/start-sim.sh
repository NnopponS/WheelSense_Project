...
if [ $? -eq 0 ]; then
    ...
    echo -e "${WHITE}  Demo Admin: ada.m / ada.m${NC}"
    echo -e "${WHITE}  Head Nurse: helen.b / helen.b${NC}"
    echo -e "${WHITE}  Supervisor: marcus.l / marcus.l${NC}"
    echo -e "${WHITE}  Observer: nina.p / nina.p${NC}"
    echo -e "${WHITE}  Observer: jason.k / jason.k${NC}"
    echo ""
