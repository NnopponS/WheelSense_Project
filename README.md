...
- Roadmaps and role breakdown: `docs/plans/wheelsense-full-roadmap.md`, `docs/plans/wheelsense-role-breakdown.md`
- MCP system guide + implementation handoff: `docs/MCP-README.md`, `docs/plans/mcp-implementation-handoff.md`
