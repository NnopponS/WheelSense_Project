...
#### 📱 Mobile Application
- [Mobile App Overview](mobile-app/wheelsense-gateway-flutter/README.md) - Flutter gateway app for BLE/Polar sensor telemetry, MQTT forwarding, alerts, and role-aware portal WebView access
