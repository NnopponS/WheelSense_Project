...
The following example clones the "[DEEPCRAFT&trade; Studio data collection](https://github.com/Infineon/mtb-example-psoc-edge-ml-deepcraft-data-collection)" application with the desired name "DataCollection" configured for the *KIT_PSE84_AI* BSP into the specified working directory, *C:/mtb_projects*:

   ```
   project-creator-cli --board-id KIT_PSE84_AI --app-id mtb-example-psoc-edge-ml-deepcraft-data-collection --user-app-name DataCollection --target-dir "C:/mtb_projects"
   ```
