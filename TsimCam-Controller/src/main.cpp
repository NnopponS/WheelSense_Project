...
const char* WIFI_SSID = "WittyNotebook";
const char* WIFI_PASSWORD = "eornnrbs";
...
#define CAMERA_FRAME_SIZE FRAMESIZE_VGA    // 640x480 - คุณภาพสูง
#define JPEG_QUALITY 20                    // คุณภาพดีมาก (0-63, ต่ำ = quality สูง) - quality สูง
...
// ปรับขนาด buffer ให้เหมาะกับ VGA JPEG
#define FRAME_POOL_SIZE 12                 // เพิ่ม pool size มากๆ เพื่อลด drop
#define MAX_FRAME_SIZE 120000              // VGA JPEG quality 20 ~80-120 KB
...
bool setupCamera() {
  ...
  Serial.printf("[Camera] VGA 640x480, Quality: %d (lower=better), Buffers: %d, Target FPS: %d\n",
...
void setup() {
  ...
  Serial.println("========================================");
  Serial.printf("  Target FPS: %d, Quality: %d, VGA 640x480\n", TARGET_FPS, JPEG_QUALITY);
  Serial.println("========================================\n");
