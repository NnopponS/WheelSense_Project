      ...
      <ScrollView style={styles.content} contentContainerStyle={styles.contentInner}>
        ...
        {tab === 'portal' ? (
          <PortalPanel
            ...
            portalFullScreen={portalFullScreen}
            setPortalFullScreen={setPortalFullScreen}
          />
        ) : null}
    ...
    <Panel
      ...
      action={
        <View style={{ flexDirection: 'row', gap: 8 }}>
          <ActionButton 
            label={portalFullScreen ? 'Exit Full' : 'Full'} 
            onPress={() => setPortalFullScreen(!portalFullScreen)} 
            variant="secondary" 
          />
