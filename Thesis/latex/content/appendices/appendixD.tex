...
\begin{table}[H]
    \centering
    \caption{ผลการผ่าน execution gate ของชุดทดสอบ AI}
    \label{tab:app_ai_execution_gate_summary}
    \renewcommand{\arraystretch}{1.18}
    \small
    \setlength{\tabcolsep}{3pt}
    \begin{tabular}{|L{0.34\textwidth}|L{0.16\textwidth}|L{0.40\textwidth}|}
        \hline
        \textbf{กลุ่มผลลัพธ์} & \textbf{จำนวนข้อ} & \textbf{การตีความ} \\ \hline
        Read-only answer & 13 & ระบบตอบหรือสรุปบริบทโดยไม่สร้างคำสั่งเปลี่ยนสถานะ \\ \hline
        Execution candidate with confirmation & 18 & ระบบสร้าง action candidate แต่ยังต้องรอผู้ใช้ยืนยันก่อน execute \\ \hline
        Clarification / safety stop & 5 & ระบบถามกลับหรือหยุดเพราะคำสั่งกำกวมสูง \\ \hline
        Policy/schema block after validation & 0 & ไม่พบ candidate ที่ถูก block เพิ่มหลังจากผ่าน Layer 4 ในชุดนี้ \\ \hline
        รวม & 36 & ครบตามชุดทดสอบในภาคผนวกนี้ \\ \hline
    \end{tabular}
\end{table}
