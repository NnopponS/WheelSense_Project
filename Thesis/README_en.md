...
- `docs/tracking/`: thesis planning and progress docs (`THESIS_IMPROVEMENT_PLAN.md`, `PROGRESS.md`, `MOCK_DATA_AUDIT.md`)
- `docs/reports/`: report-oriented supporting docs (`poster.md`, `llm-mcp_result.md`)
- `data/analysis/`: machine-readable thesis aggregates (`llm_mcp_eval_results.json`, `thesis_ch4_aggregate.json`)
- `data/surveys/`: raw survey exports used in Chapter 4
