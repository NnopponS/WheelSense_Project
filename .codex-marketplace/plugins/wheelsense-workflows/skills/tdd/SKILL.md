---
name: tdd
description: "WheelSense workflow skill copied from .windsurf/workflows/tdd.md."
---
...
3. Query MemPalace wing `wheelsense` for relevant prior decisions.
4. Apply `test-driven-development`; if unavailable as a tool, read `.windsurf/skills/test-driven-development/SKILL.md`.
5. Add `browser-testing-with-devtools` only for browser or E2E behavior.
