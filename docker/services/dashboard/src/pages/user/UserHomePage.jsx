                    ...
                    <div className="map-container" style={{ minHeight: '400px', borderRadius: 'var(--radius-lg)' }}>
                        <div className="map-canvas" style={{ minHeight: '400px' }}>
                            ...
                            {wheelchairs.map(wc => {
                                ...
                                // Highlight current user's wheelchair
                                const isMe = (currentUser?.wheelchairId && wc.id === currentUser.wheelchairId) ||
                                    (currentUser?.id && wc.patientId === currentUser.id);
                                ...
                                return (
                                    <div
                                        ...
                                        style={{
                                            ...
                                            zIndex: isMe ? 25 : 20,
                                            border: isMe ? '3px solid white' : '2px solid white',
                                            boxShadow: isMe ? '0 0 15px rgba(59, 130, 246, 0.6)' : '0 2px 4px rgba(0,0,0,0.2)',
                                            scale: isMe ? '1.2' : '1'
                                        }}
                                    ...
                                    >
                                        <div style={{
                                            ...
                                            height: isMe ? 36 : 28,
                                            borderRadius: '50%',
                                            background: isMe ? 'linear-gradient(135deg, var(--primary-500), var(--primary-700))' : 'var(--bg-card)',
                                            color: isMe ? 'white' : 'var(--text-primary)',
                                            display: 'flex',
                                            alignItems: 'center',
                                            justifyContent: 'center'
                                        }}>
                                            <svg xmlns="http://www.w3.org/2000/svg" width={isMe ? 20 : 16} height={isMe ? 20 : 16} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
