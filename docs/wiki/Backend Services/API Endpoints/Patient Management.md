...
- [vitals.py](server/app/api/endpoints/vitals.py)
...
- [patients.py (schemas)](server/app/schemas/patients.py)
- [vitals.py (schemas)](server/app/schemas/vitals.py)
- [activity.py (schemas)](server/app/schemas/activity.py)
- [devices.py (schemas)](server/app/schemas/devices.py)
- [patients.py (models)](server/app/models/patients.py)
- [vitals.py (models)](server/app/models/vitals.py)
- [patient.py (service)](server/app/services/patient.py)
- [vitals.py (service)](server/app/services/vitals.py)
- [device_management.py (service)](server/app/services/device_management.py)
...
**Diagram sources**
- [patients.py:126-261](server/app/api/endpoints/patients.py#L126-L261)
- [vitals.py:76-125](server/app/api/endpoints/vitals.py#L76-L125)
- [timeline.py:65-86](server/app/api/endpoints/timeline.py#L65-L86)
- [devices.py:136-184](server/app/api/endpoints/devices.py#L136-L184)
- [patient.py (service):80-164](server/app/services/patient.py#L80-L164)
- [vitals.py (service):12-45](server/app/services/vitals.py#L12-L45)
- [device_management.py (service):597-632](server/app/services/device_management.py#L597-L632)
- [patients.py (schemas):15-81](server/app/schemas/patients.py#L15-L81)
- [vitals.py (schemas):12-68](server/app/schemas/vitals.py#L12-L68)
- [activity.py (schemas):12-62](server/app/schemas/activity.py#L12-L62)
- [devices.py (schemas):12-93](server/app/schemas/devices.py#L12-L93)
- [patients.py (models):24-148](server/app/models/patients.py#L24-L148)
- [vitals.py (models):24-107](server/app/models/vitals.py#L24-L107)
...
**Section sources**
- [patients.py:90-261](server/app/api/endpoints/patients.py#L90-L261)
- [vitals.py:60-139](server/app/api/endpoints/vitals.py#L60-L139)
- [timeline.py:46-86](server/app/api/endpoints/timeline.py#L46-L86)
- [rooms.py:50-157](server/app/api/endpoints/rooms.py#L50-L157)
- [devices.py:136-184](server/app/api/endpoints/devices.py#L136-L184)
...
**Diagram sources**
- [patients.py:126-133](server/app/api/endpoints/patients.py#L126-L133)
- [dependencies.py:159-169](server/app/api/dependencies.py#L159-L169)
- [patient.py (service):80-93](server/app/services/patient.py#L80-L93)
...
**Diagram sources**
- [patients.py:212-223](server/app/api/endpoints/patients.py#L212-L223)
- [dependencies.py:159-169](server/app/api/dependencies.py#L159-L169)
- [patient.py (service):80-93](server/app/services/patient.py#L80-L93)
...
- [patients.py:90-261](server/app/api/endpoints/patients.py#L90-L261)
- [patients.py (schemas):15-81](server/app/schemas/patients.py#L15-L81)
- [patients.py (models):24-83](server/app/models/patients.py#L24-L83)
- [dependencies.py:328-368](server/app/api/dependencies.py#L328-L368)
...
**Diagram sources**
- [patients.py:294-313](server/app/api/endpoints/patients.py#L294-L313)
- [patient.py (service):94-142](server/app/services/patient.py#L94-L142)
- [devices.py:146-184](server/app/api/endpoints/devices.py#L146-L184)

**Section sources**
- [patients.py:283-332](server/app/api/endpoints/patients.py#L283-L332)
- [patient.py (service):94-161](server/app/services/patient.py#L94-L161)
- [patients.py (models):84-123](server/app/models/patients.py#L84-L123)
...
**Diagram sources**
- [vitals.py:76-84](server/app/api/endpoints/vitals.py#L76-L84)
- [dependencies.py:354-367](server/app/api/dependencies.py#L354-L367)
- [vitals.py (service):12-26](server/app/services/vitals.py#L12-L26)
...
**Diagram sources**
- [timeline.py:65-73](server/app/api/endpoints/timeline.py#L65-L73)
- [dependencies.py:354-367](server/app/api/dependencies.py#L354-L367)
- [activity.py (schemas):12-62](server/app/schemas/activity.py#L12-L62)
...
**Diagram sources**
- [rooms.py:116-143](server/app/api/endpoints/rooms.py#L116-L143)
...
**Section sources**
- [devices.py:136-311](server/app/api/endpoints/devices.py#L136-L311)
- [devices.py (schemas):12-93](server/app/schemas/devices.py#L12-L93)
- [device_management.py (service):597-632](server/app/services/device_management.py#L597-L632)
...
- [timeline.py:65-73](server/app/api/endpoints/timeline.py#L65-L73)
- [devices.py:136-144](server/app/api/endpoints/devices.py#L136-L144)
- [rooms.py:87-114](server/app/api/endpoints/rooms.py#L87-L114)
- [patient.py (service):80-93](server/app/services/patient.py#L80-L93)
- [vitals.py (service):12-26](server/app/services/vitals.py#L12-L26)
- [device_management.py (service):597-632](server/app/services/device_management.py#L597-L632)
- [patients.py (models):24-83](server/app/models/patients.py#L24-L83)
...
**Section sources**
- [dependencies.py:354-401](server/app/api/dependencies.py#L354-L401)
- [patient.py (service):94-161](server/app/services/patient.py#L94-L161)
- [device_management.py (service):597-632](server/app/services/device_management.py#L597-L632)
...
**Section sources**
- [dependencies.py:328-401](server/app/api/dependencies.py#L328-L401)