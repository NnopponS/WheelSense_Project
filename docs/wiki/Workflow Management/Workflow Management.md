...
- [care_workflow_jobs.py](server/app/services/care_workflow_jobs.py)
...
**Diagram sources**
- [OperationsConsole.tsx:681-865](frontend/components/workflow/OperationsConsole.tsx#L681-L865)
- [WorkflowTasksKanban.tsx:150-200](frontend/components/workflow/WorkflowTasksKanban.tsx#L150-L200)
- [WorkflowTasksHubContent.tsx:318-350](frontend/components/workflow/WorkflowTasksHubContent.tsx#L318-L350)
- [WorkflowJobsPanel.tsx:283-307](frontend/components/workflow/WorkflowJobsPanel.tsx#L283-L307)
- [WorkflowMessageAttachmentViews.tsx:105-141](frontend/components/messaging/WorkflowMessageAttachmentViews.tsx#L105-L141)
...
- [workflowTaskBoard.ts:1-47](frontend/lib/workflowTaskBoard.ts#L1-L47)
- [workflow.py:1-200](server/app/api/endpoints/workflow.py#L1-L200)
- [workflow.py:1-200](server/app/services/workflow.py#L1-L200)
- [care_workflow_jobs.py:1-200](server/app/services/care_workflow_jobs.py#L1-L200)
...
**Section sources**
- [README.md:56-73](frontend/README.md#L56-L73)
...
- [server.py:2257-2299](server/app/mcp/server.py#L2257-L2299)
...
**Diagram sources**
- [workflow.py:184-200](server/app/api/endpoints/workflow.py#L184-L200)
- [workflow.py:1-200](server/app/services/workflow.py#L1-L200)
- [care_workflow_jobs.py:121-200](server/app/services/care_workflow_jobs.py#L121-L200)
- [workflow.py:41-122](server/app/models/workflow.py#L41-L122)
...
**Diagram sources**
- [OperationsConsole.tsx:681-865](frontend/components/workflow/OperationsConsole.tsx#L681-L865)
- [OperationsConsole.tsx:571-621](frontend/components/workflow/OperationsConsole.tsx#L571-L621)

**Section sources**
- [OperationsConsole.tsx:681-865](frontend/components/workflow/OperationsConsole.tsx#L681-L865)
- [OperationsConsole.tsx:571-621](frontend/components/workflow/OperationsConsole.tsx#L571-L621)
- [README.md:63-67](frontend/README.md#L63-L67)
...
**Diagram sources**
- [WorkflowTasksKanban.tsx:178-189](frontend/components/workflow/WorkflowTasksKanban.tsx#L178-L189)
- [workflowTaskBoard.ts:13-16](frontend/lib/workflowTaskBoard.ts#L13-L16)
- [workflow.py:184-200](server/app/api/endpoints/workflow.py#L184-L200)
- [workflow.py:1-200](server/app/services/workflow.py#L1-L200)
- [workflow.py:41-58](server/app/models/workflow.py#L41-L58)
...
**Diagram sources**
- [workflow.py:123-178](server/app/models/workflow.py#L123-L178)
- [care_workflow_jobs.py:121-200](server/app/services/care_workflow_jobs.py#L121-L200)

**Section sources**
- [WorkflowJobsPanel.tsx:283-307](frontend/components/workflow/WorkflowJobsPanel.tsx#L283-L307)
- [care_workflow_jobs.py:33-87](server/app/services/care_workflow_jobs.py#L33-L87)
...
**Diagram sources**
- [workflow.py:354-390](server/app/api/endpoints/workflow.py#L354-L390)
- [workflow.py:989-1017](server/app/services/workflow.py#L989-L1017)
- [workflowMessaging.ts:1-21](frontend/lib/workflowMessaging.ts#L1-L21)
- [WorkflowMessageAttachmentViews.tsx:105-141](frontend/components/messaging/WorkflowMessageAttachmentViews.tsx#L105-L141)
- [workflow.py:67-88](server/app/models/workflow.py#L67-L88)
...
**Diagram sources**
- [server.py:2257-2299](server/app/mcp/server.py#L2257-L2299)
- [workflow.py:110-134](server/app/api/endpoints/workflow.py#L110-L134)
- [workflow.py:1-200](server/app/services/workflow.py#L1-L200)
...
- [workflowTaskBoard.ts:13-16](frontend/lib/workflowTaskBoard.ts#L13-L16)
- [care_workflow_jobs.py:33-47](server/app/services/care_workflow_jobs.py#L33-L47)
...
- Create a task
  ...
  - Reference: [OperationsConsole.tsx:681-865](frontend/components/workflow/OperationsConsole.tsx#L681-L865), [workflow.py:136-146](server/app/api/endpoints/workflow.py#L136-L146), [workflow.py:1-200](server/app/services/workflow.py#L1-L200)

- Assign a task to a person
  - Choose assignment mode “person” and select a user; the backend validates the user belongs to the current workspace.
  - Reference: [OperationsConsole.tsx:681-865](frontend/components/workflow/OperationsConsole.tsx#L681-L865), [workflow.py:136-146](server/app/api/endpoints/workflow.py#L136-L146)
...
- Move a task across Kanban columns
  ...
  - Reference: [WorkflowTasksKanban.tsx:178-189](frontend/components/workflow/WorkflowTasksKanban.tsx#L178-L189), [workflowTaskBoard.ts:13-16](frontend/lib/workflowTaskBoard.ts#L13-L16)
...
- Create a workflow job (checklist)
  ...
  - Reference: [WorkflowJobsPanel.tsx:283-307](frontend/components/workflow/WorkflowJobsPanel.tsx#L283-L307), [workflowJobs.ts:1-11](frontend/lib/workflowJobs.ts#L1-L11), [care_workflow_jobs.py:121-200](server/app/services/care_workflow_jobs.py#L121-L200)
...
- Send a role-based message with attachments
  ...
  - Reference: [WorkflowMessageAttachmentViews.tsx:105-141](frontend/components/messaging/WorkflowMessageAttachmentViews.tsx#L105-L141), [workflowMessaging.ts:1-21](frontend/lib/workflowMessaging.ts#L1-L21), [workflow.py:354-390](server/app/api/endpoints/workflow.py#L354-L390)
...
- Generate a workflow audit report
  ...
  - Reference: [OperationsConsole.tsx:571-621](frontend/components/workflow/OperationsConsole.tsx#L571-L621), [workflow.py:180-196](server/app/models/workflow.py#L180-L196)
...
- Integrate shift checklist with agent workflows
  ...
  - Reference: [server.py:2257-2299](server/app/mcp/server.py#L2257-L2299), [README.md:63-67](frontend/README.md#L63-L67)