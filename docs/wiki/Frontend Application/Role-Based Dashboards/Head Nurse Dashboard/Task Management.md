...
- [UnifiedTaskCommandBar.tsx](frontend/components/head-nurse/tasks/UnifiedTaskCommandBar.tsx)
- [UnifiedTaskKanbanBoard.tsx](frontend/components/head-nurse/tasks/UnifiedTaskKanbanBoard.tsx)
...
- [task_management.py](server/app/models/tasks.py)
- [task_management.py](server/app/schemas/tasks.py)
...
**Diagram sources**
- [CreateTaskDialog.tsx:1-472](frontend/components/head-nurse/tasks/CreateTaskDialog.tsx#L1-L472)
- [TaskDetailModal.tsx:1-1053](frontend/components/head-nurse/tasks/TaskDetailModal.tsx#L1-L1053)
- [UnifiedTaskCommandBar.tsx:1-334](frontend/components/head-nurse/tasks/UnifiedTaskCommandBar.tsx#L1-L334)
- [UnifiedTaskKanbanBoard.tsx:1-557](frontend/components/head-nurse/tasks/UnifiedTaskKanbanBoard.tsx#L1-L557)
- [tasks.py:1-690](server/app/services/tasks.py#L1-L690)
- [task_management.py:1-129](server/app/models/task_management.py#L1-L129)
- [task_management.py:1-166](server/app/schemas/task_management.py#L1-L166)
- [task_management.py](server/app/api/endpoints/task_management.py)
...
**Section sources**
- [CreateTaskDialog.tsx:32-137](frontend/components/head-nurse/tasks/CreateTaskDialog.tsx#L32-L137)
- [TaskDetailModal.tsx:185-338](frontend/components/head-nurse/tasks/TaskDetailModal.tsx#L185-L338)
- [UnifiedTaskCommandBar.tsx:74-129](frontend/components/head-nurse/tasks/UnifiedTaskCommandBar.tsx#L74-L129)
- [UnifiedTaskKanbanBoard.tsx:300-554](frontend/components/head-nurse/tasks/UnifiedTaskKanbanBoard.tsx#L300-L554)
- [tasks.py:123-294](server/app/services/tasks.py#L123-L294)
...
**Diagram sources**
- [tasks.py:123-207](server/app/services/tasks.py#L123-L207)
- [task_management.py](server/app/api/endpoints/task_management.py)
...
**Diagram sources**
- [CreateTaskDialog.tsx:72-137](frontend/components/head-nurse/tasks/CreateTaskDialog.tsx#L72-L137)
...
**Diagram sources**
- [TaskDetailModal.tsx:238-338](frontend/components/head-nurse/tasks/TaskDetailModal.tsx#L238-L338)
- [tasks.py:209-296](server/app/services/tasks.py#L209-L296)
...
**Section sources**
- [UnifiedTaskCommandBar.tsx:74-334](frontend/components/head-nurse/tasks/UnifiedTaskCommandBar.tsx#L74-L334)
...
**Section sources**
- [UnifiedTaskKanbanBoard.tsx:40-242](frontend/components/head-nurse/tasks/UnifiedTaskKanbanBoard.tsx#L40-L242)
- [UnifiedTaskKanbanBoard.tsx:300-554](frontend/components/head-nurse/tasks/UnifiedTaskKanbanBoard.tsx#L300-L554)
...
**Diagram sources**
- [task_management.py:22-129](server/app/models/task_management.py#L22-L129)
...
**Diagram sources**
- [tasks.py:44-689](server/app/services/tasks.py#L44-L689)
- [task_management.py](server/app/models/tasks.py)
- [task_management.py](server/app/schemas/tasks.py)
...
**Section sources**
- [CreateTaskDialog.tsx:108-137](frontend/components/head-nurse/tasks/CreateTaskDialog.tsx#L108-L137)
- [TaskDetailModal.tsx:322-338](frontend/components/head-nurse/tasks/TaskDetailModal.tsx#L322-L338)
- [tasks.py:130-155](server/app/services/tasks.py#L130-L155)
- [tasks.py:296-396](server/app/services/tasks.py#L296-L396)
- [tasks.py:418-473](server/app/services/tasks.py#L418-L473)
- [UnifiedTaskKanbanBoard.tsx:370-376](frontend/components/head-nurse/tasks/UnifiedTaskKanbanBoard.tsx#L370-L376)
