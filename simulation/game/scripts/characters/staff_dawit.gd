...
func _on_go_to_room(character_name: String, room_name: String):
	...
	print("Dawit: Received command to go to ", room_name)
	...
	if room_position != Vector2.ZERO:
		...
		print("Dawit: Navigating to ", room_name, " at ", room_position)
	else:
		print("Dawit: Could not find room ", room_name)
