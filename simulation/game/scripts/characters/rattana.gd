...
const CHARACTER_NAME = "rattana"

var is_moving: bool = false
var target_position: Vector2 = Vector2.ZERO
var directions = [Vector2.UP, Vector2.DOWN, Vector2.LEFT, Vector2.RIGHT]
var current_location: String = "Room404"
...
func _ready():
	...
	action_menu.set_patient_name("Rattana")
...
func _on_bridge_connected():
	print("Rattana: Connected to WheelSense backend")

func _on_bridge_disconnected():
	print("Rattana: Disconnected from WheelSense backend")
...
func _on_go_to_room(character_name: String, room_name: String):
	...
	print("Rattana: Received command to go to ", room_name)
	...
	if room_position != Vector2.ZERO:
		...
		is_moving = true
		print("Rattana: Navigating to ", room_name, " at ", room_position)
	else:
		print("Rattana: Could not find room ", room_name)
...
func _on_dispatch_accepted(character_name: String, room_name: String, accepted_by: String):
	if room_name == current_location:
		print("Rattana: Dispatch accepted by ", accepted_by, ", nurse will arrive soon")
...
func start_receiving_treatment(doctor_name: String):
	...
	print("Rattana: กำลังรับการปฐมพยาบาล...หมอ", doctor_name, "!")

# หมอจะเรียกฟังก์ชันนี้ตอนรักษาเสร็จ (ครบ 2 วินาที)
func finish_treatment():
	...
	start_waiting()
	print("Rattana: อาการดีขึ้นแล้ว กลับสู่สภาวะปกติ")
