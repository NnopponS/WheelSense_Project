...
const translations = {
  ...
  "caregivers.directorySubtitle": {
    en: "Directory of workspace caregivers with roles and contact details.",
    th: "รายชื่อผู้ดูแลในเวิร์กสเปซ พร้อมบทบาทและข้อมูลติดต่อ",
  },
  ...
  "caregivers.listNoMatches": {
    ...
    th: "ไม่มีบุคคลากรทีตรงกับการค้นหา",
  },
