...
const translations: Record<string, Record<string, string>> = {
    ...
    'nav.appliances': { en: 'Appliance Control', th: 'ควบคุมอุปกรณ์' },
    'nav.sensors': { en: 'Sensor Monitoring', th: 'ติดตามเซ็นเซอร์' },
    'nav.video': { en: 'Camera', th: 'กล้อง' },
    'nav.location': { en: 'Location', th: 'ตำแหน่ง' },
