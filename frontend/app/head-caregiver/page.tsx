        ...
        <Card className="border-border/70">
          <CardHeader className="flex-row items-start justify-between gap-3 space-y-0 pb-3">
            ...
            <Button asChild size="sm" variant="outline">
              <Link href="/head-caregiver/alerts">
                ...
                {sortedAlerts.length ? (
                  sortedAlerts.map((alert) => {
                    ...
                    return (
                      <Link
                        key={alert.id}
                        href={alert.patient_id ? `/head-caregiver/personnel/${alert.patient_id}` : "/head-caregiver/alerts"}
                ...
                {patientAttentionRows.length ? (
                  patientAttentionRows.map((entry) => {
                    ...
                    return (
                      <Link
                        key={patient.id}
                        href={`/head-caregiver/personnel/${patient.id}`}
                        className="group flex items-start justify-between gap-3 rounded-xl border border-border/70 px-3 py-3 transition-colors hover:bg-muted/40"
                      >
                        <div className="min-w-0 flex-1">
                          <div className="flex items-center gap-2">
        ...
        <div className="space-y-4">
          <Card className="border-border/70">
            <CardHeader className="flex-row items-start justify-between gap-3 space-y-0 pb-3">
              ...
              <Button asChild size="sm" variant="outline">
                <Link href="/head-caregiver/caregivers">
      ...
      <div className="grid gap-4 xl:grid-cols-2">
        <Card className="border-border/70">
          <CardHeader className="flex-row items-start justify-between gap-3 space-y-0 pb-3">
            ...
            <Button asChild size="sm" variant="outline">
              <Link href="/head-caregiver/tasks">
        ...
        <Card className="border-border/70">
          <CardHeader className="flex-row items-start justify-between gap-3 space-y-0 pb-3">
            ...
            <Button asChild size="sm" variant="outline">
              <Link href="/head-caregiver/floorplans">
                ...
                {roomlessPatientRows.length ? (
                  roomlessPatientRows.map((entry) => (
                    <Link
                      ...
                      href={`/head-caregiver/personnel/${entry.patient.id}`}
                      className="group flex items-start justify-between gap-3 rounded-xl border border-border/70 px-3 py-3 transition-colors hover:bg-muted/40"
                    >
                      <div className="min-w-0 flex-1">
                        <div className="flex items-center gap-2">
