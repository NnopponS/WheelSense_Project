      ...
      },
      {
        ...
        cell: ({ row }) => (
          <Button asChild size="sm" variant="outline">
            <Link href={`/supervisor/patients/${row.original.id}`}>Open detail</Link>
          </Button>
        ),
      },
    ],
    ...
    <div className="space-y-6 animate-fade-in">
      <div>
        ...
        <p className="mt-1 text-sm text-muted-foreground">
          Supervisor view of patient roster and care-level status.
        </p>
      </div>
      ...
      <DataTableCard
        ...
        description="All patients in current workspace."
        data={rows}
        columns={columns}
