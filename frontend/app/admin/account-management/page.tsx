...
const STAFF_ROLES = ["admin", "head_caregiver", "head_caregiver", "caregiver"] as const;
...
function roleLabel(role: string, t: (key: TranslationKey) => string): string {
  switch (role) {
    ...
    case "head_caregiver":
    case "head_nurse":
    case "supervisor": return t("shell.roleHeadCaregiver");
    case "caregiver":
    case "observer": return t("shell.roleCaregiver");
...
export default function AccountManagementPage() {
  ...
  const [createRole, setCreateRole] = useState<AccountDraft["role"]>("caregiver");
